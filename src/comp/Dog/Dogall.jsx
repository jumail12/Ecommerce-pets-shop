...
const Dogall = () => {
        ...
        useEffect(() => {
            axios.get("http://localhost:3001/products")
              .then((res) => setDogAll(res.data))
              .catch(() => console.log("Error in fetching..!"));
          }, []);

          

         const dogProducts =dogAll.filter((item)=>{
            if(item.catogory==="dog-food"||item.catogory==="dog-beds"){
                return item;
            }
         })
  ...
  return (
    ...
    <div className="p-8 bg-gray-100">
      <h1 className="text-3xl font-bold mb-6 text-center">All Products(Dog)</h1>
