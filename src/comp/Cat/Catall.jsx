...
const Catall = () => {
    ...
    useEffect(() => {
      ...
      const allCatdata=data.filter((item)=>{
        if(item.catogory==="cat-food" || item.catogory==="cat-treat" ){
            return item;
        }
      });
  ...
  return (
    ...
    <div className="p-8 bg-gray-100">
      <h1 className="text-3xl font-bold mb-6 text-center">All Products(Cat)</h1>
